...
create :: proc(width, height: int, title: string, gl_major_version: i32 = 4, gl_minor_version: i32 = 5) -> (window: Window, err: Window_Error) {

  if !bool(glfw.Init()) {
    err = .GLFW_Failed_To_Init
    return
  }
  ...
  if window_handle == nil {
    err = .GLFW_Failed_To_Load_Window
    return
  }
